...
enum CitySpotInfo {
    static var citySpotList: [CitySpot] = [
        CitySpot(title: "하나우마 베이",
                 description: "아름다운 자연을 감상할 수 있는 스노쿨링 명소",
                 spotImage: "https://images.unsplash.com/photo-1539498508910-091b5e859b1d?q=80&w=3250&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
                 grade: 4.8,
                 save: 6932,
                 like: false,
                 ad: false),
        CitySpot(title: "쿠알로아 랜치",
        ...
        CitySpot(title: "하와이 여행을 가고 싶다면?",
                 ...
                 like: nil,
                 ad: true),
        CitySpot(title: "철도 박물관",
                 description: "일본 철도의 역사를 둘러볼 수 있는 박물관",
                 spotImage: "https://images.unsplash.com/photo-1562326303-31bb8d0f4873?q=80&w=3264&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
                 grade: 2.8,
                 save: 3,
                 like: false,
                 ad: false),
        CitySpot(title: "도쿄 디즈니랜드",
        ...
        CitySpot(title: "도쿄 타워",
                 ...
                 spotImage: "https://images.unsplash.com/photo-1513407030348-c983a97b98d8?q=80&w=3272&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
                 grade: 4.1,
                 save: 37077,
                 like: false,
                 ad: false),
        CitySpot(title: "도쿄 여행 예약은?",
                 description: nil,
                 spotImage: nil,
                 grade: nil,
                 save: nil,
        ...
        CitySpot(title: "서귀포 매일 올레 시장",
                 ...
                 spotImage: "https://images.unsplash.com/photo-1511018761631-2e3eb1e4c972?q=80&w=3270&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
                 grade: 3.9,
                 save: 45399,
                 like: false,
                 ad: false),
        CitySpot(title: "성산일출봉",
